...
def get_new_grasp_position(scores, uv, zs, xs=None, ys=None):
    ...
    z = []
    score = []
    npzfile_A = np.load('/home/yisleyici/Desktop/train_matrix.npz')
    npzfile_rest = np.load('/home/yisleyici/Desktop/feature_space.npz')

    uv_list = npzfile_rest['uv']
    list_x = npzfile_rest['list_x']
    list_y = npzfile_rest['list_y']
    list_z = npzfile_rest['list_z']
...
if __name__ == '__main__':
    npzfile = np.load('/home/yisleyici/Desktop/feature_space.npz')
